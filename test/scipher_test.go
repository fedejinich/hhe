...
import (
	...
	. "github.com/fedejinich/pasta-go" // todo(fedejinich) shouldn't import this to use the sdk
)

func TestNewPastaSCipher(t *testing.T) {
	pastaConfig := SCipherConfig{
	...
	if NewSCipher(PASTA, pastaConfig) == nil {
		t.Errorf("couldn't create pasta cipher")
	}
}
